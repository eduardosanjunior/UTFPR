...
public class SubidaEncosta {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < execucoes; i++) {
            ...
            SubidaEncosta se = new SubidaEncosta(30, 6); // qtd est. sucessores e iteracoes
            // interrompe execuções se encontrar a solução
            if (se.buscar()) { // retorna falso se encontrou melhor local; retorna true se encontrou solução
                break;
            }
        }
