 ...
 * @version 20170910
 *
 * toda a implementação foi realizada no linux através da IDE Eclipse Oxygen
 */
package beltraoluis.estrutura.Arvore;
...
/**
 * A classe NoArvore representa a estrutura básica para a construção de uma
 * arvore com tipo generico devendo o mesmo ser encapsulado por um objeto.
 *
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Byte.html>Byte</a>
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Short.html>Short</a>
 * @see
 ...
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Float.html>Float</a>
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Double.html>Double</a>
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Character.html>Character</a>
 * @see
 * <a href=http://docs.oracle.com/javase/7/docs/api/java/lang/Boolean.html>Boolean</a>
 *
...
public class NoArvore<T extends Comparable<T>> implements Comparable<NoArvore<T>> {
     ...
     * @param pai é o pai do nó se for passado o valor null esse nó é a raiz da
     * arvore.
     */
    ...
    NoArvore(int[] dado, NoArvore<T> pai) {
        super();
        this.dados = dados;
        this.pai = pai;
        try {
    ...
    public void setNivel(int nivel) throws NullPointerException {
        if (this.pai == null) {
            throw new NullPointerException("Nó não possui um pai");
        }
        this.nivel = nivel;
    }
